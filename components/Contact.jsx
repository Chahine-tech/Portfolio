...
export default function Contact() {
  ...
  return (
    <section>
      ...
      <div className="relative z-10 rounded-md shadow-md bg-[#03315e] p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            ...
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#03315e] hover:border hover:border-blue-500 p-4">
                <svg
